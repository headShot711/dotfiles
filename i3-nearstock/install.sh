...
sudo pacman -S --noconfirm --needed xorg go lxappearance nitrogen cmus picom evince acpi i3-wm i3status timeshift i3lock i3blocks dmenu curl base-devel mtools dosfstools exfat-utils linux-headers gvfs gvfs-mtp ntfs-3g htop neofetch tlp yt-dlp dunst xclip unzip p7zip bluez bluez-utils blueman networkmanager network-manager-applet dhcpcd wpa_supplicant xdg-utils xdg-user-dirs alsa-utils pavucontrol ranger leafpad ttf-liberation scrot vlc mpv thunar feh alacritty firefox vim polkit-gnome wget qbittorrent eza
